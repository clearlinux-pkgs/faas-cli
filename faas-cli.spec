...
Source0  : https://github.com/openfaas/faas-cli/archive/0.14.6/faas-cli-0.14.6.tar.gz
...
%prep
%setup -q -n faas-cli-0.14.6
cd %{_builddir}/faas-cli-0.14.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661580726
