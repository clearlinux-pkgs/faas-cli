...
Source0  : https://github.com/openfaas/faas-cli/archive/0.14.8/faas-cli-0.14.8.tar.gz
...
%prep
%setup -q -n faas-cli-0.14.8
cd %{_builddir}/faas-cli-0.14.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664316299
...
cp %{_builddir}/faas-cli-%{version}/vendor/github.com/inconshreveable/mousetrap/LICENSE %{buildroot}/usr/share/package-licenses/faas-cli/9174f93c54ad0022bbb9b445480cfb6b4217226a
cp %{_builddir}/faas-cli-%{version}/vendor/github.com/konsorten/go-windows-terminal-sequences/LICENSE %{buildroot}/usr/share/package-licenses/faas-cli/e2ee43b586677eaafd7dd7af25adff48adfa7cf3
